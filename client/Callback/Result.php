...
namespace TillPayments\Client\Callback;

use TillPayments\Client\Data\Customer;
use TillPayments\Client\Data\Result\ResultData;
use TillPayments\Client\Transaction\Error;
 ...
 *
 * @package TillPayments\Client\Callback
 */
class Result {
