...
namespace TillPayments\Client\Xml;

use TillPayments\Client\Data\CreditCardCustomer;
use TillPayments\Client\Data\Customer;
use TillPayments\Client\Data\IbanCustomer;
use TillPayments\Client\Data\Request;
use TillPayments\Client\Exception\InvalidValueException;
use TillPayments\Client\Schedule\ScheduleData;
use TillPayments\Client\Exception\TypeException;
 ...
 * Class Generator
 *
 * @package TillPayments\Client\Xml
 */
class Generator {
     ...
     * @var string
     */
    protected $namespaceRoot = 'http://gateway.tillpayments.com';
    ...
    /**
     * @param \TillPayments\Client\Transaction\VoidTransaction $transaction
     * @param $method
     *
     * @return \DOMElement
     */
