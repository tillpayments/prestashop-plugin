...
var initPaymentGatewayCloutSeamless = function (seamlessForm) {
  ...
  var $seamlessCardHolderFirstNameInput = $('#till-payments-ccFirstName-' + formId, $seamlessForm);
  var $seamlessCardHolderLastNameInput = $('#till-payments-ccFirstName-' + formId, $seamlessForm);
  var $seamlessCardNumberInput = $('#till-payments-ccCardNumber-' + formId, $seamlessForm);
  var $seamlessCvvInput = $('#till-payments-ccCvv-' + formId, $seamlessForm);
  var $seamlessExpiryMonthInput = $('#till-payments-ccExpiryMonth-' + formId, $seamlessForm);
  var $seamlessExpiryYearInput = $('#till-payments-ccExpiryYear-' + formId, $seamlessForm);
