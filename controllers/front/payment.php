...
/**
 * Class TillPaymentsPaymentModuleFrontController
 *
 * @extends ModuleFrontController
 * @property TillPayments module
 */
class TillPaymentsPaymentModuleFrontController extends ModuleFrontController
{
    /**
     * @var Order
     */
    ...
    public function postProcess()
    {
        ...
        $this->module->validateOrder(
            $cart->id,
            \Configuration::get(TillPayments::TILL_PAYMENTS_OS_STARTING),
        ...
        try {
             ...
             * gateway client
             */
            TillPayments\Client\Client::setApiUrl(Configuration::get('TILL_PAYMENTS_HOST', null));
            $client = new TillPayments\Client\Client(
                Configuration::get('TILL_PAYMENTS_' . $prefix . '_ACCOUNT_USER', null),
                Configuration::get('TILL_PAYMENTS_' . $prefix . '_ACCOUNT_PASSWORD', null),
                Configuration::get('TILL_PAYMENTS_' . $prefix . '_API_KEY', null),
                Configuration::get('TILL_PAYMENTS_' . $prefix . '_SHARED_SECRET', null)
            );
            ...
            switch (Configuration::get('TILL_PAYMENTS_' . $prefix . '_TRANSACTION_TYPE', null)) {
                case 'PREAUTHORIZE':
    ...
    {
        if ($order->current_state == Configuration::get(TillPayments::TILL_PAYMENTS_OS_STARTING)) {
